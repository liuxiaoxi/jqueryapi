    ...
    "results":[
			    ...
			    },
			    {
			        ...
			        "children": [
			            ...
			            {
			                "id": "event.isDefaultPrevented",
			                "text": "event.isDefaultPrevented()",
			                "info": "根据事件对象中是否调用过 event.preventDefault() 方法来返回一个布尔值。 "
			            },
			            {
			                "id": "event.isImmediatePropagationStopped",
			                "text": "event.isImmediatePropagationStopped()",
			                "info": "根据事件对象中是否调用过 event.stopImmediatePropagation() 方法来返回一个布尔值。"
			            },
			            {
			                "id": "event.isPropagationStopped",
			                "text": "event.isPropagationStopped()",
			                "info": " 根据事件对象中是否调用过event.stopPropagation() 方法来返回一个布尔值。 "
			            },
			            {
			                "text": "event.namespace",
			                "info": " 当事件被触发时此属性包含指定的命名空间。"
			            },
			            {
			                "text": "event.pageX",
			                "info": "鼠标相对于文档的左边缘的位置。 "
			            ...
			            },
			            {
			                ...
			                "info": "阻止剩余的事件处理函数执行并且防止事件冒泡到DOM树上。"
			            },
			            {
			                "id": "event.stopPropagation",
			                "text": "event.stopPropagation()",
			                "info": "防止事件冒泡到DOM树上，也就是不触发的任何前辈元素上的事件处理函数。"
			            },
			            {
			                "text": "event.target",
			                "info": " 最初触发事件的DOM元素。 "
			            },
			            {
			                ...
			                "info": " 这个属性返回事件触发时距离1970年1月1日的毫秒数。 "
			            },
			            {
			                "text": "event.type",
			                "info": " 描述事件类型。"
			            ...
			            {
			                "text": "event.which",
			                "info": " 针对键盘和鼠标事件，这个属性能确定你到底按的是哪个键。"
			            },
			            {
			                "id": "focus",
			                "text": ".focus()",
			    ...
			    },
			    {
			        ...
			        "children": [
			            ...
			            {
			                "text": "[name|=value] 属性包选择器 ",
			                "info": "选择指定属性等于给定字符串或以该字符串为前缀（该字符串后跟一个连字符“-” ）的元素。"
			            },
			            {
			            ...
			            {
			                "id": "Child Selector \"parent > child\"",
			            ...
			            {
			                "id": "Descendant Selector \"ancestor descendant\"",
			            ...
			            {
			                "text": "Has Attribute Selector [name]",
			                "info": "选择所有具有指定属性的元素，该属性可以是任何值。 "
			            },
			            {
			                "id": ":has Selector",
			                "text": ":has() Selector",
			            ...
			            {
			                "text": "Multiple Attribute Selector [name=value][name2=value2]",
			                "info": "选择匹配所有指定的属性筛选器的元素"
			            },
			            {
			                "id": "Multiple Selector \"selector1, selector2, selectorN\"",
			                "text": "Multiple Selector (\"selector1, selector2, selectorN\")",
			                "info": "将每一个选择器匹配到的元素合并后一起返回。"
			            },
			            {
			                "id": "Next Adjacent Selector \"prev + next\"",
			                "text": "Next Adjacent Selector (\"prev + next\")",
			                "info": "选择所有紧接在 “prev” 元素后的 “next” 元素"
			            },
			            {
			                "id": "Next Siblings Selector \"prev ~ siblings\"",
